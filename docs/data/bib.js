define({ entries : {
    "ABO12": {
        ...
        "keywords": "source:paper, users:pro, users:casual, gran:full, gran:preview, gran:dots, gran:abstr, nt:list, nt:grid, nt:plot, nt:map, nt:other, nt:barchart, t:timeline, t:timeaxis, task:elem, task:syn, task:temp, type:image, data:time, data:place, data:actor, data:category, data:other, ex:search, ex:detail",
        "number": "11",
        "pages": "3",
        "series": "D-Lib",
    ...
    "ADM16": {
        ...
        "journal": "Leonardo",
        "keywords": "source:paper, users:pro, gran:dots, nt:plot, nt:net, t:timeaxis, t:color, task:syn, task:temp, type:video, data:time, data:relation, ex:search, ex:overview, ex:vertical, ex:detail, ex:horizontal, evaluation:yes",
        "number": "2",
        "pages": "209--210",
        ...
        "title": "Culturegraphy",
        "type": "article",
        "url": "http://www.mitpressjournals.org/doi/abs/10.1162/LEON_a_01230",
        "urldate": "2016-11-28",
        "volume": "50",
        "year": "2016"
    },
    "AML05": {
        ...
        "keywords": "source:paper, users:pro, gran:full, gran:preview, gran:abstr, nt:list, nt:grid, nt:map, nt:net, nt:3d, t:none, task:elem, type:object, data:object, data:other, data:ontology, ex:search, ex:horizontal, evaluation:yes",
    ...
    "BCS16": {
        ...
        "keywords": "source:paper, users:pro, gran:dots, gran:abstr, nt:map, t:color, task:temp, type:text, data:time, data:place, ex:search, ex:overview",
        "pages": "1--17",
    ...
    "BKJ17": {
        ...
        "keywords": "source:paper, users:casual, gran:full, gran:abstr, nt:plot, nt:barchart, t:timeaxis, t:timeline, task:syn, task:temp, type:image, data:time, data:actor, data:category, ex:overview, ex:vertical, ex:detail",
        "series": "VINCI",
    ...
    "BNS15": {
        ...
        "keywords": "source:paper, users:casual, gran:preview, gran:abstr, nt:plot, nt:map, t:timeline, t:timeaxis, task:elem, type:image, data:time, data:place, data:actor, data:relation, ex:overview",
    ...
    "BTC10": {
        ...
        "keywords": "source:paper, gran:preview, nt:grid, nt:other, task:elem, type:image, data:time, ex:horizontal, evaluation:yes",
        "month": "nov,",
        "number": "6",
        "pages": "1261--1270",
        "series": "TVCG",
    ...
    "Buc11": {
        ...
        "isbn": "9781450307444",
        "keywords": "source:paper, gran:dots, gran:abstr, nt:map, nt:other, nt:barchart, t:timeaxis, task:syn, type:text, data:time, data:place, data:actor, data:category, ex:overview",
        "pages": "429--430",
        "publisher": "ACM",
        "series": "{JCDL}",
    ...
    "But13": {
        ...
        "keywords": "source:paper, users:casual, gran:full, gran:preview, gran:abstr, nt:list, nt:grid, nt:barchart, t:timeaxis, task:elem, task:syn, task:temp, type:image, data:time, data:actor, ex:search, ex:overview, ex:vertical, ex:detail, ex:horizontal",
        "publisher": "Archives \\& Museum Informatic",
        "series": "MW",
    ...
    "CDE15": {
        ...
        "keywords": "source:paper, gran:dots, nt:net, nt:wordcloud, t:timeaxis, task:syn, type:image, type:text, type:video, type:audio, type:object, data:time, data:actor, data:text, ex:search, ex:overview",
        "pages": "186--194",
        "publisher": "IEEE",
        "series": "IC3K",
    ...
    "CLF04": {
        ...
        "isbn": "9781581138320",
        "keywords": "source:paper, users:casual, gran:preview, nt:list, nt:grid, t:none, task:syn, type:image, data:category, ex:search, ex:overview, ex:horizontal, ex:paths, evaluation:yes",
        "pages": "334--342",
        "publisher": "ACM",
        "series": "{JCDL}",
    ...
    "COS12": {
        ...
        "keywords": "source:paper, users:casual, gran:preview, nt:list, nt:cluster, t:none, task:elem, type:image, data:object, data:category, ex:horizontal, evaluation:yes",
        "month": "apr,",
        "number": "2",
        "pages": "169--182",
        "series": "ISJ",
    ...
    "Cob16": {
        ...
        "keywords": "source:paper, users:pro, users:casual, gran:full, gran:preview, nt:list, nt:grid, nt:net, t:none, task:elem, task:syn, type:image, data:relation, data:category, ex:search, ex:overview, ex:vertical, ex:detail, ex:horizontal, ex:paths, evaluation:yes",
        "publisher": "Archives \\& Museum Informatics",
        "series": "MW",
    ...
    "Cro16": {
        ...
        "keywords": "source:paper, gran:preview, nt:plot, nt:cluster, nt:barchart, t:timeaxis, task:elem, type:image, data:object, ex:overview",
        "language": "en",
        "number": "2",
        "pages": "178--197",
        "series": "DAH",
    ...
    "DDS10": {
        ...
        "keywords": "source:paper, users:casual, gran:dots, nt:list, nt:grid, nt:map, nt:wordcloud, t:none, task:elem, type:image, data:place, data:other, ex:search, ex:overview, ex:detail, ex:horizontal",
        "publisher": "Archives \\& Museum Informatics",
        "series": "MW",
    ...
    "DLL15": {
        ...
        "keywords": "source:paper, users:casual, gran:full, gran:abstr, nt:3d, t:other, task:elem, type:image, type:text, type:video, type:audio, type:object, data:other, data:ontology, ex:search, ex:detail, ex:horizontal, evaluation:yes",
        "month": "jun,",
        "pages": "100--109",
        "publisher": "IEEE",
        "series": "INTETAIN",
    ...
    "DLR10": {
        ...
        "keywords": "source:paper, users:casual, gran:full, nt:net, t:other, task:elem, task:syn, type:image, type:text, type:video, data:ontology, ex:overview, ex:vertical, ex:detail, ex:paths",
        "publisher": "Archives \\& Museum Informatic",
        "series": "MW",
    ...
    "DMTS14": {
        ...
        "keywords": "source:paper, users:casual, gran:preview, gran:dots, gran:abstr, nt:list, nt:map, nt:other, t:timeline, t:timeaxis, task:elem, task:syn, task:temp, type:image, data:time, data:place, data:category, ex:search, ex:overview, ex:vertical, ex:detail, ex:horizontal, evaluation:yes",
        "pages": "65--72",
        "publisher": "ACM",
        "series": "AVI",
        "shorttitle": "{ArtVis}",
    ...
    "DPC17": {
        ...
        "keywords": "source:paper, gran:full, gran:abstr, nt:plot, nt:net, nt:other, nt:barchart, nt:wordcloud, t:timeaxis, task:elem, task:syn, task:temp, type:image, type:text, type:video, type:audio, type:object, data:time, data:place, data:actor, data:relation, data:category, ex:overview, ex:vertical, ex:detail",
        "number": "23",
        "series": "IDJ",
    ...
    "DPT12": {
        ...
        "keywords": "source:paper, users:pro, gran:full, gran:preview, gran:dots, nt:map, nt:net, nt:other, t:other, task:elem, task:syn, task:temp, type:image, type:text, data:time, data:place, data:text, data:ontology, ex:search, ex:overview, ex:detail",
        "pages": "539--546",
        "publisher": "ACM",
        "series": "{AVI}",
    ...
    "Dea15": {
        ...
        "keywords": "source:paper, users:pro, users:casual, gran:full, gran:abstr, nt:list, nt:map, nt:other, t:timeaxis, task:elem, type:text, data:time, data:place, data:text, ex:search, ex:overview, ex:detail, evaluation:yes",
        "number": "1",
        "pages": "14--34",
        "series": "WTSQ",
    ...
    "GAFM11": {
        ...
        "keywords": "source:paper, users:casual, gran:full, gran:preview, gran:dots, nt:net, nt:3d, t:timeaxis, t:other, task:temp, type:image, data:time, data:actor, data:relation, data:ontology, ex:search, ex:overview, ex:vertical, ex:detail, ex:horizontal, evaluation:yes",
        "pages": "46:1--46:8",
        "publisher": "ACM",
        "series": "{ACE}",
    ...
    "GPD17": {
        ...
        "keywords": "source:paper, users:pro, users:casual, gran:full, gran:preview, nt:cluster, nt:barchart, nt:wordcloud, t:timeaxis, task:elem, task:syn, task:temp, type:image, data:time, data:text, data:herarchy, data:category, ex:overview, ex:vertical, ex:detail, ex:horizontal, evaluation:yes",
        "number": "11",
        "series": "DHQ},\t",
    ...
    "HFM16": {
        ...
        "journal": "IEEE Transactions on Visualization and Computer Graphics",
        "keywords": "source:paper, users:pro, users:casual, gran:full, gran:abstr, nt:list, nt:treemap, nt:barchart, nt:wordcloud, t:timeaxis, task:elem, task:syn, task:temp, type:text, data:time, data:herarchy, data:category, ex:search, ex:overview, ex:detail, ex:horizontal, evaluation:yes",
        "number": "1",
        "pages": "429--438",
        "series": "TVCG",
        ...
        "type": "article",
        "url": "http://ieeexplore.ieee.org/abstract/document/7192666/",
        "urldate": "2017-05-18",
        "volume": "22",
        "year": "2016"
    },
    "HSC08": {
        ...
        "journal": "IEEE Transactions on Visualization and Computer Graphics",
        "keywords": "source:paper, users:casual, gran:full, gran:dots, nt:net, t:other, task:syn, task:temp, task:syn, type:image, type:text, data:time, data:text, data:relation, data:category, ex:overview, ex:detail, ex:horizontal, evaluation:yes",
        "number": "6",
        "pages": "1181--1188",
        "series": "TVCG",
        "shorttitle": "{EMDialog}",
    ...
    "HT16": {
        ...
        "keywords": "source:paper, users:pro, users:casual, gran:preview, nt:list, nt:map, nt:net, t:anim, task:elem, task:syn, type:image, type:text, type:video, type:audio, type:object, data:place, data:relation, data:ontology, ex:search, ex:overview, ex:detail",
        "month": "dec,",
        "pages": "837--846",
        "series": "JASRep",
    ...
    "HW10": {
        ...
        "keywords": "source:paper, users:casual, gran:full, gran:dots, gran:abstr, nt:list, nt:grid, nt:net, nt:barchart, nt:wordcloud, t:timeaxis, task:elem, type:image, type:text, data:object, data:time, data:text, ex:overview, ex:vertical, ex:detail, ex:horizontal",
        "pages": "51--58},\t",
    ...
    "KBD15": {
        ...
        "keywords": "source:paper, users:pro, gran:full, gran:preview, nt:barchart, t:timeline, t:timeaxis, task:temp, type:image, data:time, ex:overview, ex:vertical, ex:detail, evaluation:yes",
        "series": "CGVC",
    ...
    "KH14": {
        ...
        "keywords": "source:paper, users:casual, gran:full, gran:preview, nt:grid, nt:wordcloud, nt:3d, t:timeaxis, task:elem, type:image, data:time, data:text, data:relation, data:category, ex:overview, ex:detail, ex:horizontal, evaluation:yes",
        "publisher": "Archives \\& Museum Informatic",
        "series": "MW",
        "shorttitle": "{mARChive}",
    ...
    "KNA07": {
        ...
        "keywords": "source:paper, users:pro, gran:abstr, nt:barchart, t:timeline, t:timeaxis, task:syn, type:text, data:time, data:category, ex:search, ex:overview, ex:vertical, ex:detail, ex:horizontal, evaluation:yes",
    ...
    "MHR12": {
        ...
        "keywords": "source:paper, users:pro, users:casual, gran:full, gran:preview, gran:dots, nt:list, nt:grid, nt:map, nt:net, t:timeline, t:timeaxis, t:anim, task:elem, task:syn, task:temp, type:image, type:text, type:video, type:audio, type:object, data:time, data:place, data:actor, data:relation, data:category, data:ontology, ex:search, ex:overview, ex:detail, ex:horizontal, ex:paths",
        "number": "1",
        "pages": "85--109",
        "series": "SWJ",
    ...
    "MPCC13": {
        ...
        "keywords": "source:paper, users:pro, users:casual, gran:preview, gran:dots, nt:list, nt:grid, nt:map, nt:net, t:timeline, task:syn, task:temp, type:image, data:time, data:place, data:actor, data:text, data:relation, ex:search, ex:overview, ex:vertical, ex:detail, ex:horizontal, ex:paths",
        "pages": "21",
        "publisher": "ACM",
        "series": "CHItaly",
    ...
    "NMG13": {
        ...
        "keywords": "source:paper, users:pro, gran:full, gran:preview, nt:map, t:timeline, task:syn, task:temp, type:image, data:time, data:place, ex:overview, ex:detail, ex:horizontal, ex:paths",
        "month": "dec,",
        "number": "4",
        "pages": "692--699",
        "series": "DSH",
    ...
    "NMM14": {
        ...
        "keywords": "source:paper, users:pro, gran:full, gran:preview, gran:dots, gran:abstr, nt:list, nt:grid, nt:net, t:timeaxis, task:elem, task:temp, type:image, data:object, data:time, data:actor, data:relation, ex:search, ex:overview, ex:vertical, ex:detail, ex:horizontal, evaluation:yes",
        "pages": "241--250",
        "publisher": "IEEE",
        "series": "IV",
    ...
    "PE16": {
        ...
        "keywords": "source:paper, users:pro, gran:preview, gran:dots, nt:list, nt:cluster, t:none, task:syn, type:image, ex:overview, ex:vertical, ex:horizontal, evaluation:yes",
        "note": "\"\",",
        "number": "\"\",",
        "pages": "\"127 - 138\",",
        "series": "C\\&G",
    ...
    "RCM17": {
        ...
        "keywords": "source:paper, gran:full, gran:preview, nt:map, nt:wordcloud, nt:3d, t:other, task:elem, type:image, type:text, data:time, data:place, data:category, ex:detail, ex:horizontal",
        "pages": "215--219",
        "publisher": "ACM",
        "series": "IUI",
    ...
    "REN08": {
        ...
        "keywords": "source:paper, users:pro, users:casual, nt:list, nt:wordcloud, nt:3d, t:timeline, task:elem, type:image, type:text, type:object, data:other, ex:overview, ex:detail, ex:horizontal, ex:paths",
        "pages": "113--119",
        "publisher": "ACM",
        "series": "{DIMEA}",
    ...
    "RHQ14": {
        ...
        "keywords": "source:paper, users:casual, gran:preview, gran:abstr, nt:list, nt:map, t:timeline, task:elem, type:image, data:time, data:place, ex:search, ex:overview, ex:vertical, ex:detail, ex:horizontal, evaluation:yes",
        "series": "tsio",
    ...
    "SIBdS16": {
        ...
        "issn": "1940-5758",
        "journal": "Code4Lib",
        "keywords": "source:paper, users:pro, gran:preview, gran:dots, nt:list, nt:map, nt:barchart, t:timeline, task:elem, type:image, type:text, type:video, type:audio, type:object, data:time, data:place, data:category, ex:search, ex:overview, ex:vertical, ex:detail",
        "number": "31",
    ...
    "SJG14": {
        ...
        "issn": "1550-6037",
        "keywords": "source:paper, users:casual, gran:preview, gran:abstr, nt:list, nt:treemap, nt:other, nt:wordcloud, t:other, task:elem, type:image, type:text, type:video, type:audio, type:object, data:other, ex:search, ex:vertical, ex:detail, ex:horizontal, evaluation:yes",
        "month": "July",
        "pages": "94-101",
        "publisher": "IEEE",
        "series": "IV",
    ...
    "SVF06": {
        ...
        "isbn": "9781595933546",
        "keywords": "source:paper, users:pro, gran:abstr, nt:list, nt:net, nt:barchart, t:timeaxis, t:other, task:syn, type:image, type:text, data:time, data:place, data:herarchy, ex:search, ex:overview, ex:vertical, ex:horizontal, evaluation:yes",
        "pages": "1--10",
        "publisher": "ACM",
        "series": "{JCDL}",
    ...
    "THC12": {
        ...
        "isbn": "9781450310154",
        "keywords": "source:paper, users:casual, gran:preview, gran:dots, nt:list, nt:net, nt:set, nt:other, t:timeline, t:other, task:elem, type:image, type:text, data:time, data:actor, data:category, data:other, ex:search, ex:overview, ex:vertical, ex:detail, ex:horizontal",
        "pages": "1461--1470",
        "publisher": "ACM",
        "series": "{CHI}",
    ...
    "TSdlCV14": {
        ...
        "keywords": "source:paper, users:pro, gran:full, gran:abstr, nt:map, nt:net, nt:barchart, t:timeline, t:timeaxis, task:elem, task:syn, task:temp, type:text, data:time, data:place, data:text, data:relation, ex:search, ex:overview, ex:detail, ex:vertical",
        "pages": "153--158",
        "publisher": "ACM",
        "series": "DATeCH",
    ...
    "UTA10b": {
        ...
        "booktitle": "Museums \\& the {Web} 2010",
        "keywords": "source:paper, users:casual, gran:dots, gran:abstr, nt:map, nt:net, nt:set, nt:treemap, t:timeline, t:timeaxis, task:syn, task:temp, type:image, type:text, type:video, type:audio, type:object, data:time, data:place, data:category, ex:overview, evaluation:yes",
        "publisher": "Archives \\& Museum Informatic",
        "series": "MW",
    ...
    "Whi15a": {
        ...
        "journal": "Digital Humanities Quarterly",
        "keywords": "source:paper, users:casual, gran:full, gran:preview, nt:treemap, t:timeline, t:other, task:elem, task:syn, task:temp, type:image, data:time, data:text, ex:overview, ex:vertical, ex:detail, ex:horizontal",
        "number": "1",
        "series": "DHQ",
    ...
    "XEJJ14": {
        ...
        "keywords": "source:paper, users:pro, gran:abstr, nt:treemap, nt:other, nt:wordcloud, t:other, task:syn, type:image, type:text, type:video, type:audio, type:object, data:time, data:place, data:text, data:relation, ex:search, ex:overview, ex:vertical, ex:detail, ex:horizontal, evaluation:yes",
        "language": "en",
        "number": "2",
        "pages": "159--183",
        "series": "IVI",
    ...
    "YMDK11": {
        ...
        "issn": "0018-9162",
        "journal": "Computer",
        "keywords": "source:paper, users:pro, gran:preview, gran:dots, nt:grid, nt:plot, t:timeaxis, t:other, task:syn, task:temp, type:image, data:object, data:time, ex:overview, evaluation:yes",
        "month": "dec,",
        "number": "12",
        "pages": "39--48",
        "series": "Computer",
    ...
    "dBOI15": {
        ...
        "keywords": "source:paper, users:pro, users:casual, gran:full, gran:preview, gran:abstr, nt:list, nt:grid, nt:map, nt:other, t:timeline, t:timeaxis, task:elem, task:temp, type:image, type:text, type:video, data:object, data:other, data:ontology, ex:search, ex:overview, ex:vertical, ex:detail, ex:horizontal, evaluation:yes",
        "month": "dec,",
        "number": "3",
        "pages": "152--158",
        "series": "WebSem",
    ...
    "p_Museumoftheworld": {
        ...
        "author": "British Museum with Google and Weir + Wong",
        "keywords": "source:tool, gran:full, gran:preview, gran:dots,  nt:net, nt:set,  t:timeaxis, t:3d,  t:other,  ex:search, ex:overview, ex:vertical, ex:detail, ex:horizontal, ex:paths",
        "title": "The Museum of the World",
        "titleaddon": "Museum of the World",
        "type": "online",
        "url": "https://britishmuseum.withgoogle.com/",
        "year": "2015"
    },
    "p_dariah_geo-browser": {
        "author": "{DARIAH}{\\textbackslash}\\_DE",
        "keywords": "source:tool, gran:dots, gran:abstr, nt:map, t:anim, t:timeaxis, ex:overview, ex:vertical, ex:detail",
        "title": "Geo-Browser",
        "type": "online",
    ...
    "p_dpla": {
        ...
        "author": "{DPLA}",
        "keywords": "source:tool, gran:dots, gran:abstr, nt:list,  nt:map,  nt:barchart,  t:timeaxis,  ex:search, ex:overview, ex:vertical, ex:detail, ex:horizontal, ex:paths",
        "title": "Digital Public Library of America \u00b7 Timeline",
        "type": "online",
        "url": "https://dp.la/timeline",
        "year": "2014"
    },
    "p_dressregister": {
        "keywords": "source:tool, gran:full, gran:preview,  gran:abstr, nt:list,  nt:other,  t:timeaxis,  ex:search, ex:overview, ex:vertical",
        "title": "The Australian Dressregister",
        "type": "online",
        "url": "http://www.australiandressregister.org/timeline/",
        "year": "2013"
    },
    "p_eclapbrowser": {
        ...
        "author": "{ECLAP}",
        "keywords": "source:tool, gran:full, gran:preview, gran:dots,  nt:list,  nt:net,  t:none, ex:search, ex:overview, ex:vertical, ex:detail, ex:horizontal",
        "title": "{ECLAP} Social Graph",
        "type": "online",
        "url": "http://www.digitalmeetsculture.net/article/eclap-social-graph/",
        "year": "2013"
    },
    "p_googleculturalinstitute": {
        "abstract": "Explore collections and stories from around the world with Google Arts \\& Culture.",
        "author": "Google",
        "keywords": "source:tool, gran:full, gran:preview,  nt:grid,  t:timeaxis,  ex:search, ex:overview, ex:vertical, ex:detail, ex:horizontal, ex:paths",
        "title": "Google Arts \\& Culture",
        "type": "online",
        "url": "https://www.google.com/culturalinstitute/beta/",
        "year": "2015"
    },
    "p_heilbrunn": {
        ...
        "author": "{MET}",
        "keywords": "source:tool, nt:list,  nt:map,  t:timeline,  ex:search, ex:overview, ex:vertical, ex:detail, ex:horizontal",
        "title": "Heilbrunn Timeline of Art History",
        "titleaddon": "The Met\u2019s Heilbrunn Timeline of Art History",
        "type": "online",
        "url": "http://www.metmuseum.org/toah/chronology/",
        "year": "2015"
    },
    "p_historypin": {
        "keywords": "source:tool, gran:full, gran:preview, gran:dots,  nt:list, nt:grid,  nt:map,  t:other,  ex:search, ex:overview, ex:vertical,  ex:horizontal, ex:paths",
        "title": "Historypin",
        "type": "online",
    ...
    "p_inventingabstraction": {
        "author": "{MoMa}",
        "keywords": "source:tool, gran:full, gran:preview,  nt:net,  t:none,  ex:overview, ex:vertical, ex:detail, ex:horizontal",
        "title": "{MoMA} {\\textbar} Inventing Abstraction 1910\u20131925",
        "type": "online",
        "url": "http://www.moma.org/interactives/exhibitions/2012/inventingabstraction/",
        "year": "2012"
    },
    "p_linkedvisions": {
        "keywords": "source:tool, gran:full, gran:preview, gran:dots,  nt:net,  t:none,  ex:overview, ex:vertical, ex:detail",
        "title": "Linked Visions",
        "type": "online",
        "url": "http://linkedvisions.artic.edu/",
        "year": "2015"
    },
    "p_mappingtitian": {
        "keywords": "source:tool, gran:preview, gran:dots,  nt:grid,  nt:map,  nt:other,  t:anim, t:timeline,  ex:search, ex:overview, ex:vertical, ex:detail",
    ...
    "p_nypl": {
        ...
        "author": "Foo, Brian",
        "keywords": "source:tool, gran:full, gran:preview,  nt:list, nt:grid,  t:other,  ex:overview, ex:vertical, ex:detail",
        "title": "{NYPL} Public Domain Release 2016 - Visualization",
        "titleaddon": "{NYPL} Public Domain Release 2016 - Visualization",
        "type": "online",
        "url": "http://publicdomain.nypl.org/pd-visualization/",
        "year": "2016"
    },
    "p_objectphoto": {
        "keywords": "source:tool, nt:map, nt:net,  nt:other,  t:anim, t:timeline,  ex:search, ex:overview, ex:vertical, ex:detail, ex:horizontal, ex:paths",
        "title": "Object:Photo {\\textbar} {MoMA}",
        "type": "online",
        "url": "https://www.moma.org/interactives/objectphoto/#home",
        "year": "2014"
    },
    "p_palladio": {
        "keywords": "source:tool, gran:preview, gran:dots,  nt:grid,  nt:map, nt:net,  t:anim,  t:timeaxis,  t:color,  ex:overview, ex:vertical, ex:detail, ex:horizontal",
        "title": "Palladio",
        "type": "online",
    ...
    "p_republicofletters": {
        "author": "Stanford U",
        "keywords": "source:tool, gran:abstr, nt:list,  nt:map, nt:net,  nt:3d,  t:timeaxis,  ex:overview, ex:vertical,  ex:horizontal",
    ...
    "p_researchspace": {
        "keywords": "source:tool, nt:map,  t:timeline,  ex:search, ex:overview, ex:vertical, ex:detail, ex:horizontal",
        "title": "Researchspace",
        "type": "online",
        "url": "http://www.researchspace.org/",
        "year": "2017"
    },
    "p_selfiexploratory": {
        "author": "Manovich et al",
        "keywords": "source:tool, gran:full, gran:preview,  gran:abstr,  nt:grid,  nt:map,  nt:other,  t:none,  ex:overview, ex:vertical,  ex:horizontal",
    ...
    "p_sfmomaartscope": {
        "keywords": "source:tool, gran:full, gran:preview,  nt:grid,  t:none, ex:search, ex:overview, ex:vertical, ex:detail, ex:horizontal",
        "title": "{SFMOMA} {\\textbar} Explore Modern Art {\\textbar} {SFMOMA} {ArtScope}",
        "type": "online",
        "url": "https://www.sfmoma.org/experience/artscope/#r",
        "year": "2009"
    },
    "p_uncertainarchive": {
        "keywords": "source:tool, gran:full, gran:preview,  nt:grid,  nt:cluster,  nt:net, nt:set,  nt:3d,  t:none,  ex:overview, ex:vertical, ex:detail, ex:horizontal",
        "title": "Your uncertain archive",
        "type": "online",
        "url": "http://olafureliasson.net/uncertain",
        "year": "2014"
    }
}});